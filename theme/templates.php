...
<head>
    ...
    <title>Home | Fashion Factory</title>
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/shop/log.jpg" alt="logo" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Fashion</span>Factory</h2>
              <p>E Commerce website for purchasing the best designs and selling  of best designed cloths </p>
            </div>
          </div>
          <div class="col-sm-7">        
          </div>
