      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
             ...
             <tfoot><tr><td></td></tr></tfoot>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td>Rs 546 <?php echo  $result->PRICE ?></td>
                          <td>Rs 546 <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output></td>
                        </tr>
              <?php
                        }
            ...
            <div class="container"> 
              <div class="row"> <h3  align="right" margin-right="20%">Total Price : Rs 546 <span  id="sum">0.00</span></h3></div>  
                </div>
