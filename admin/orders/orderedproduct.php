	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> Rs 169 '.number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> RS 369 <output><?php echo number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : RS 8369 <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : RS 50 <?php echo number_format($cur->DELFEE,2); ?></p>
		  		<p align="right">Overall Price : Rs 8419 <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div> 
		</div>   
