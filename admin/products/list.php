        	...
        	<!-- /.col-lg-12 -->
			  ...
			  <tbody>
				    ...
				    echo '<td style="padding:0px;">
				  		...
				  		echo '<td> Rs 357 '.  number_format($result->PROPRICE,2).'</td>';
				  		echo '<td> Rs 357 '.  number_format($result->PRODISCOUNT,0).'</td>';
				  		echo '<td> Rs 357 '.  number_format($result->PRODISPRICE,2).'</td>';
